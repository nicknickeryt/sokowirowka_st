...
#define BUTTON_ENCODER_EXTI_IRQn EXTI1_IRQn
...
#define SERVO_BOTTOM_Pin GPIO_PIN_10
#define SERVO_BOTTOM_GPIO_Port GPIOA
#define SERVO_TOP_Pin GPIO_PIN_11
#define SERVO_TOP_GPIO_Port GPIOA
